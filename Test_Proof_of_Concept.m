...
% function [x_vector_sum] = Landung(v_air, hoehe_LDG, c_A_F)
% load Projekt_specs.mat;
% load Ergebnisse_Fluegel_Tank_NP.mat;
% 
% 
...
% 
% [c_w_R_interm, alpha_Rumpf_grad_interm, c_A_alpha] = Rumpfwiderstand(Machzahl, Abwindfaktor, c_A_ges, v_air);
...
[x_vector_sum] = Landung(v_air, hoehe_LDG, c_A_F);