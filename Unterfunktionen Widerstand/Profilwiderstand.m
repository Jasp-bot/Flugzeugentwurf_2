...
function [c_w_p, c_w_p_min_Re] = Profilwiderstand(v_gegeben,c_A_F)
...
c_w_p = trapz((((c_w_p_eta .*  ((Ergebnisse_Fluegel.Fluegeltiefen_eta_oR)/ (Ergebnisse_Fluegel.l_m))) * 10^(-2)).')); % Achtung Potenz kann inkoreckt sein
