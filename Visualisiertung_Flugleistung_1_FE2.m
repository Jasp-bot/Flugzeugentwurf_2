...
pl(1) = plot(Ergebnisse_Flugleistung_1.v_s_1g, Ergebnisse_Flugleistung_1.hoehe_m, '--b');
pl(2) = plot(Ergebnisse_Flugleistung_1.v_s_min, Ergebnisse_Flugleistung_1.hoehe_m, 'k');
pl(3) = plot(Ergebnisse_Flugleistung_1.v_BO, Ergebnisse_Flugleistung_1.hoehe_m, 'r');
...
% 
pl(9) = plot(Ergebnisse_Flugleistung_1.v_min_HFD, Ergebnisse_Flugleistung_1.hoehe_m.', '.-g');
pl(10) = plot(Ergebnisse_Flugleistung_1.v_max_HFD, Ergebnisse_Flugleistung_1.hoehe_m, '.-k');

pl(11) = plot((specs.Ma_CR * ISA.a(hoehe_CR)), hoehe_CR, '*r'); % Design point

legend('v_s_{1g}', 'v_s_{min}', 'Ma_{BO}', 'SR_{max}', 'SEP_{max}', 'SET_{max}', 'SE_{max}', 'v_{MO}', 'v_{min}', 'v_{max}', 'DP', 'FontSize',15 ,Location='eastoutside');
