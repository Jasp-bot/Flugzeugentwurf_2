...
p2(9) = plot([0.05*(Ergebnisse_Fluegel.b/2), Ergebnisse_Fluegel.b/2-specs.R_rumpf],...
    [(tan(DT.phi_HK_dt)*0.05*(Ergebnisse_Fluegel.b/2))+Ergebnisse_Fluegel.Fluegeltiefen_eta(1,round(length(Ergebnisse_Fluegel.Fluegeltiefen_eta)*0.95))*(1-0.15),...
...
p2(10) = plot([0.05*(Ergebnisse_Fluegel.b/2), ((Ergebnisse_Fluegel.b/2)*(1-(DT.y_kink)))],...
    [(1-0.65)*Ergebnisse_Fluegel.Fluegeltiefen_eta(1,round(length(Ergebnisse_Fluegel.Fluegeltiefen_eta)*0.95))+(tan(DT.phi_HK_dt)*0.05*(Ergebnisse_Fluegel.b/2)),...
...
p2(14) = plot([0.05*(Ergebnisse_Fluegel.b/2) 0.05*(Ergebnisse_Fluegel.b/2)],...
    [(tan(DT.phi_HK_dt)*0.05*(Ergebnisse_Fluegel.b/2))+Ergebnisse_Fluegel.Fluegeltiefen_eta(1,round(length(Ergebnisse_Fluegel.Fluegeltiefen_eta)*0.95))*(1-0.65),...
    (tan(DT.phi_HK_dt)*0.05*(Ergebnisse_Fluegel.b/2))+Ergebnisse_Fluegel.Fluegeltiefen_eta(1,round(length(Ergebnisse_Fluegel.Fluegeltiefen_eta)*0.95))*(1-0.15)],...
    'blue');
